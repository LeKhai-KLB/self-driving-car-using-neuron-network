...
public class CarController : MonoBehaviour
{
    ...
    private void CalculateFitness()
    {
        ...
        //print("thong so: " + overallFitness);
        //print("thoi gian: " + timeSinceStart);

        if (timeSinceStart > 20 && overallFitness < 40)
        {
            print("Death at 103 " + overallFitness + " Time: " + timeSinceStart);
            Death();
        }

        if (overallFitness >= 1200)
        {
            print("Death at 108 " + overallFitness);
            Death();
        }
